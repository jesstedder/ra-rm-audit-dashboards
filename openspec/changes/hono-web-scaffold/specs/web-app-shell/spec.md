...
The system SHALL serve a React single-page application from `src/web/` that renders at `/`. Vite builds the app to `dist/` which Cloudflare Pages serves as static assets.
